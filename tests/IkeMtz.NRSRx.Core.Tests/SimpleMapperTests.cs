...
namespace IkeMtz.NRSRx.Core.Tests
{
  ...
  public class SimpleMapperTests : BaseUnigrationTests
  {
    ...
    {
      var source = new ValidationTestObject()
      {
        Id = Guid.NewGuid(),
      ...
      var dest = new ValidationTestObject();
      SimpleMapper<ValidationTestObject>.Instance.ApplyChanges(source, dest);
  ...
  public class ValidationTestObject : IIdentifiable
  {
    public ValidationTestObject()
    {
