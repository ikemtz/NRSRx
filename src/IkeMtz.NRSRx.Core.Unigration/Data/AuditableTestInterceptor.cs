...
namespace IkeMtz.NRSRx.Core.Unigration.Data
{
  ...
  /// </summary>
  /// <remarks>
  /// Initializes a new instance of the <see cref="AuditableTestInterceptor"/> class.
  /// </remarks>
  /// <param name="currentUserProvider">The current user provider.</param>
  public class AuditableTestInterceptor(ICurrentUserProvider currentUserProvider) : ISaveChangesInterceptor
  {
    /// <summary>
    /// Gets the current user provider.
    /// </summary>
    public ICurrentUserProvider CurrentUserProvider { get; } = currentUserProvider;
